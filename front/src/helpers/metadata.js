  ...
  if (typeof props.seo !== 'undefined' && typeof props.seo !== 'undefined') {
    ...
    if (typeof seodata !== 'undefined') {
      const title = seometa.title
        ? seometa.title
        : 'Vidi Commerce: discover the first video commerce website builder in the world.'
      ...
      const description = seodata.description
        ? seodata.description
        : 'Vidi Commerce Official Website | Create a Video Commerce Website'
      const socialTitle = seodata.social_title
        ? seodata.social_title
        : 'Vidi Commerce finally allows you to create modern video commerce websites.'
      const socialDescription = seodata.social_description
        ? seodata.social_description
        : 'Vidi Commerce has launched its video commerce website builder. Try it our for free and start building a mobile-first ecommerce site populated with full screen videos. Tell your brand story through videos and host live streaming sessions to sell your products from your website.'
      ...
      seometa.push(
        <meta property="twitter:title" content={socialTitle} key={3} />,
      )
      seometa.push(
        <meta property="og:description" content={socialDescription} key={4} />,
      )
      seometa.push(
        <meta
        ...
        if (seodata.media.media_metadata.width)
          seometa.push(
            <meta
              ...
              content={seodata.media.media_metadata.width}
              key={8}
            />,
          )
        if (seodata.media.media_metadata.height)
          seometa.push(
            <meta
              ...
              content={seodata.media.media_metadata.height}
              key={9}
            />,
          )
      }
        ...
        if (seodata.time_data.publish_date)
          seometa.push(
            <meta
              ...
              content={seodata.time_data.publish_date}
              key={10}
            />,
          )
        ...
        if (seodata.time_data.modified_date)
          seometa.push(
            <meta
              ...
              content={seodata.time_data.modified_date}
              key={11}
            />,
          )
      }
      if (typeof seodata.canonical !== 'undefined' && seodata.canonical != '') {
        linkUrl.push(
          <link rel="canonical" href={createUrl(seodata.canonical)} key={0} />,
        )
      }
      if (typeof seodata.url !== 'undefined' && seodata.url != '') {
        seometa.push(
          <meta property="og:url" content={createUrl(seodata.url)} key={12} />,
        )
      ...
      if (typeof seodata.is_amp !== 'undefined' && seodata.is_amp == 1) {
        linkUrl.push(
          <link
            rel="amphtml"
            href={createUrl(getAMPURL(seodata.url, seodata.locale))}
            key={13}
          />,
        )
      }
      ...
      if (typeof seodata.alternate !== 'undefined') {
        linkUrl.push(
          <link rel="alternate" href={createUrl(seodata.alternate)} key={14} />,
        )
      }
